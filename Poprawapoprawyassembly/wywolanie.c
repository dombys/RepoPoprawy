...
int main(int argc, char *argv[]) {
  ...
  wynik = (char *)malloc(maxlen * sizeof(char));
  przepisana = (char *)malloc(maxlen * sizeof(char));
  Num1 = (char *)malloc(maxlen * sizeof(char));
  Num2 = (char *)malloc(maxlen * sizeof(char));
  Final = (char *)malloc(maxlen * sizeof(char));
...
/*
  ...
  */
  ...
  Final[i]=dodaj(wynik,przepisana,i);
    }
    }
  if (strlen1 < strlen2){
